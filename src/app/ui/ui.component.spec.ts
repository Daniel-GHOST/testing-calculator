...
////////////////////////////////////////////////////////////////////////////////////////
  ...
  it("shuld substract operator1 and operator2 when i click the substraction button ", () => {
    // Arrange
    component.operator1 = 5.0;
    component.operator2 = 2.5;
    let restButton = fixture.debugElement.query(By.css(".substraction-button"));

    // Act
    restButton.triggerEventHandler("click", null);
...
/////////////////////////////////////////////////////////////////////
  ...
  it("shuld multiplication operator1 and operator2 when i click the multiplication button ", () => {
    // Arrange
    component.operator1 = 5.0;
    component.operator2 = 2.5;
    let multButton = fixture.debugElement.query(By.css(".multiplication-button"));
